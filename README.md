...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/aous)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/aous
```

A live public deployment of this template is available at [https://aous.templates.workers.dev](https://aous.templates.workers.dev)
